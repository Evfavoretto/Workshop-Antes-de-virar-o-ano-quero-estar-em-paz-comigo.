...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .trustbar{margin-top:18px;padding:10px 0}
    .trust{display:grid;gap:10px;grid-template-columns:1fr}
    @media(min-width:880px){.trust{grid-template-columns:repeat(2,1fr)}}
    ...
    .sticky-cta{position:fixed;left:12px;right:12px;bottom:12px;z-index:9998;display:none;justify-content:center}
...
<body>
  ...
  <a class="whats-float" href="https://chat.whatsapp.com/CeXf6hjhBziAzvXl9HGFFp" target="_blank" rel="noopener" aria-label="Entrar no grupo do Workshop">
